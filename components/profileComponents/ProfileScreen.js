...
import { StyleSheet, Text, View, TouchableHighlight, TouchableOpacity, Image,
    Alert, ScrollView, TextInput, FlatList,Button } from 'react-native';
        ...
        return (
            ...
            <ScrollView>
                <View style={styles.container}>
                    <Button onPress={this.handleGoToEdit} title="Rediger "/>
                    ...
                    <View style={styles.card}>
                        <Text style={styles.cardTittle}>Personlig information</Text>
